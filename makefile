...
_DEPS = Node.hpp Edge.hpp Dijkstra.hpp Reader.hpp Graph.hpp

_OBJ = Node.o Edge.o Dijkstra.o Reader.o Graph.o

_TEST = testCatch.o testNode.o testEdge.o testDijkstra.o testReader.o testGraph.o
